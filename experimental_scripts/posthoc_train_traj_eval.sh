...
#SBATCH --array 1-8
#SBATCH --job-name=posthoc_train_traj_eval
#SBATCH -o /n/home12/binxuwang/Github/DiffusionObjectRelation/cluster_logs/posthoc_train_traj_eval.%N_%A_%a.out           # STDOUT
#SBATCH -e /n/home12/binxuwang/Github/DiffusionObjectRelation/cluster_logs/posthoc_train_traj_eval.%N_%A_%a.err           # STDERR
