...
class LanguageModelSAERunnerConfig:
    ...
    Args:
        ...
        cached_activations_path (str): The path to the cached activations.
        time_step (int): The time step to use when generating activations.
    ...
    time_step: int = 7
    # SAE Parameters
    architecture: Literal["standard", "gated", "jumprelu", "topk"] = "jumprelu"
    d_in: int = 768
