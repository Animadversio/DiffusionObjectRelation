...
def main(args):
    if args.model_name not in config_dict:
        raise ValueError(f"Model name {args.model_name} not supported")
    config = config_dict[args.model_name]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="DiT_XL-2", type=str, required=False, help="Model name to convert.")
    parser.add_argument(
        "--image_size",
        default=1024,
        type=int,
