...
@MODELS.register_module()
def PixArt_L_2(**kwargs):
    return PixArt(depth=24, hidden_size=768, patch_size=2, num_heads=12, **kwargs)

@MODELS.register_module()
def PixArt_B_2(**kwargs):
    return PixArt(depth=12, hidden_size=768, patch_size=2, num_heads=12, **kwargs)
