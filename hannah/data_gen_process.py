...
Usage: 
    ...
    python unified_data_gen_process.py --config config.json --num_images 10000 --resolution 128 --radius 16 --ObjRelDataset Single --encoder_type T5 --model_max_length 20 --dataset_name objectRelSingle_pilot_temp
...
'''
Mixed: single_dataset, double_dataset, single_ratio, total_length
Single: num_images, resolution, radius, transform
Double: num_images, resolution, radius, transform

Abstract: single_dataset, double_dataset, single_ratio, num_images, resolution, radius, transform 

New_single: single_dataset=None, double_dataset=None, single_ratio=1, num_images=10000, resolution=None, radius=None, transform=None

New_double: single_dataset=None, double_dataset=None, single_ratio=0, num_images=10000, resolution=None, radius=None, transform=None
