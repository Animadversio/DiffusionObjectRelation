...
for prompt_idx in range(len(validation_prompts)):
    for random_seed in range(10):
        ...
        for (x,y) in object_location:
            ...
            fig.tight_layout()
            fig.savefig(f"/n/home13/xupan/sompolinsky_lab/object_relation/Jacobian_figures/{validation_prompts[prompt_idx]}_seed_{random_seed}_xy_{x}_{y}_denoiser.png")
            print(f"Saved {validation_prompts[prompt_idx]}_seed_{random_seed}_xy_{x}_{y}_denoiser.png")
